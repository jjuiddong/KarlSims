	...
	OUT set<PxU16> &vtxIndices0, OUT set<PxU16> &vtxIndices1 )
{
	...
	SampleRenderer::CalculateCenterPoint(findParentBoneIndex, positions, bones, boneStride, numVerts, meshCenter0);
	SampleRenderer::CalculateCenterPoint(findChildBoneIndex, positions, bones, boneStride, numVerts, meshCenter1);

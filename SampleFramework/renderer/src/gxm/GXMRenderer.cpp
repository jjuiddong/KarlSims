...
Renderer(DRIVER_LIBGXM, desc.errorCallback, assetDir), m_platform(SampleFramework::SamplePlatform::platform()), m_shaderPatcher(NULL)
{
...
RendererTexture3D *GXMRenderer::createTexture3D(const RendererTexture3DDesc &desc)
{

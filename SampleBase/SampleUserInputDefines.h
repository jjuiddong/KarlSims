...
#define DIGITAL_INPUT_EVENT_DEF(var, winKey, xbox360key, ps3Key, andrKey, osxKey, psp2Key, iosKey, linuxKey, wiiuKey)   {\
...
#define ANALOG_INPUT_EVENT_DEF(var, sensitivity, winKey, xbox360key, ps3Key, andrKey, osxKey, psp2Key, iosKey, linuxKey, wiiuKey)  {\

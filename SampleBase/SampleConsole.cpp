...
void Console::collectInputEvents(std::vector<const SampleFramework::InputEvent*>& inputEvents)
{
	...
	DIGITAL_INPUT_EVENT_DEF(CONSOLE_OPEN,				WKEY_TAB,		XKEY_TAB,		PS3KEY_TAB,			AKEY_UNKNOWN,	OSXKEY_TAB,			PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	LINUXKEY_TAB,		WIIUKEY_UNKNOWN);
	DIGITAL_INPUT_EVENT_DEF(CONSOLE_ESCAPE,				WKEY_ESCAPE,	XKEY_ESCAPE,	PS3KEY_ESCAPE,		AKEY_UNKNOWN,	OSXKEY_ESCAPE,		PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	LINUXKEY_ESCAPE,	WIIUKEY_UNKNOWN);
	DIGITAL_INPUT_EVENT_DEF(CONSOLE_ENTER,				WKEY_RETURN,	XKEY_RETURN,	PS3KEY_RETURN,		AKEY_UNKNOWN,	OSXKEY_RETURN,		PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	LINUXKEY_RETURN,	WIIUKEY_UNKNOWN);
	DIGITAL_INPUT_EVENT_DEF(CONSOLE_BACKSPACE,			WKEY_BACKSPACE,	XKEY_BACKSPACE,	PS3KEY_BACKSPACE,	AKEY_UNKNOWN,	OSXKEY_BACKSPACE,	PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	LINUXKEY_BACKSPACE,	WIIUKEY_UNKNOWN);
	DIGITAL_INPUT_EVENT_DEF(CONSOLE_LIST_COMMAND_UP,	WKEY_UP,		XKEY_UP,		PS3KEY_UP,			AKEY_UNKNOWN,	OSXKEY_UP,			PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	LINUXKEY_UP,		WIIUKEY_UNKNOWN);
	DIGITAL_INPUT_EVENT_DEF(CONSOLE_LIST_COMMAND_DOWN,	WKEY_DOWN,		XKEY_DOWN,		PS3KEY_DOWN,		AKEY_UNKNOWN,	OSXKEY_DOWN,		PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	LINUXKEY_DOWN,		WIIUKEY_UNKNOWN);
	DIGITAL_INPUT_EVENT_DEF(CONSOLE_SCROLL_UP,			WKEY_PRIOR,		XKEY_PRIOR,		PS3KEY_PRIOR,		AKEY_UNKNOWN,	OSXKEY_PRIOR,		PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	LINUXKEY_PRIOR,		WIIUKEY_UNKNOWN);
	DIGITAL_INPUT_EVENT_DEF(CONSOLE_SCROLL_DOWN,		WKEY_NEXT,		XKEY_NEXT,		PS3KEY_NEXT,		AKEY_UNKNOWN,	OSXKEY_NEXT,		PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	LINUXKEY_NEXT,		WIIUKEY_UNKNOWN);
}
